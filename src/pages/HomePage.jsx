...
const HomePage = () => {
  ...
  return (
    <div className='home-page-container'>
      ...
      <figure className='home-page-container-figure'>
        <img src="../assets/recipes1.PNG" alt="" />
        <img src="../assets/recipes2.PNG" alt="" />
        <img src="../assets/recipes3.PNG" alt="" />
        <img src="../assets/recipes4.PNG" alt="" />
        <img src="../assets/recipes5.PNG" alt="" />
        <img src="../assets/recipes6.PNG" alt="" />
        <img src="../assets/recipes7.PNG" alt="" />
        <img src="../assets/recipes8.PNG" alt="" />
